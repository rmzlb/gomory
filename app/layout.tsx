...
export const metadata: Metadata = {
  ...
  description: 'Professional cutting optimization tool using two-stage guillotine algorithm with NFDH heuristic. Minimize waste, reduce cuts, and optimize material usage for woodworking, metalworking, glass cutting, and industrial manufacturing. Free online tool with PDF export.',
  keywords: 'cutting optimizer, guillotine cutting, cutting stock problem, material optimization, wood cutting, panel cutting, NFDH algorithm, Gomory algorithm, board optimization, waste minimization, cutting plan generator, woodworking calculator, sheet optimization, material calculator, cut list optimizer, panel saw optimizer, cutting diagram, manufacturing optimization',
  ...
  openGraph: {
    ...
    description: 'Advanced two-stage guillotine cutting algorithm for optimal material usage. Minimize waste and cuts with our free online tool.',
  ...
  twitter: {
    ...
    description: 'Professional cutting optimization with two-stage guillotine algorithm. Free online tool.',
    images: ['/og-image.png'],
    creator: '@rmzlb',
  },
  robots: {
