...
export default function VerificationCard({
  ...
  return (
    ...
    >
      <h3 className="mb-3 text-base font-medium">✅ Carte de vérification</h3>
      ...
      <div className="grid grid-cols-2 gap-4 text-sm">
        ...
        <div className="space-y-2">
          <div className="mb-1 font-medium text-neutral-700">Quantités par référence</div>
          {specs.map((s) => {
      ...
      <div className="mt-4 border-t border-neutral-100 pt-3">
        <div className="text-sm">
          Statut:{' '}
          {allMatch ? (
            <span className="font-medium text-green-600">OK – toutes les pièces sont placées</span>
          ) : (
            <span className="font-medium text-red-600">Erreur – pièces manquantes</span>
          )}
        </div>
      </div>
    </motion.div>
