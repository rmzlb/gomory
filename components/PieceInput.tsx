  ...
  return (
    <div className="space-y-4">
          ...
          {pieces.map((piece, index) => {
            ...
            return (
              <motion.div
                ...
                className="group rounded-lg bg-neutral-50 p-3 transition-colors hover:bg-neutral-100"
              >
                ...
                <div className="mb-2 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <input
                      ...
                      className="w-12 rounded border border-neutral-200 bg-white px-2 py-1 text-center text-sm font-medium transition-colors focus:border-neutral-400 focus:outline-none"
                      placeholder="ID"
                    />
                  </div>
                  ...
                  <motion.button
                    ...
                    className="rounded-lg border border-neutral-200 bg-white p-2 transition-all hover:border-red-300 hover:bg-red-50 active:bg-red-100 sm:opacity-0 sm:group-hover:opacity-100"
                    aria-label={`Supprimer pièce ${piece.id}`}
                  >
                    <svg
                      className="h-4 w-4 text-neutral-500 transition-colors hover:text-red-600"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
                  <div>
                    <label className="mb-0.5 block text-xs text-neutral-500 sm:mb-1">L (mm)</label>
                    <input
                      type="text"
                      inputMode="numeric"
                      pattern="[0-9]*"
                  ...
                  <div>
                    <label className="mb-0.5 block text-xs text-neutral-500 sm:mb-1">H (mm)</label>
                    <input
                      type="text"
                      inputMode="numeric"
                      pattern="[0-9]*"
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.99 }}
        onClick={addPiece}
        className="w-full rounded-lg border-2 border-dashed border-neutral-200 py-2.5 text-sm font-medium text-neutral-600 transition-all hover:border-neutral-300 hover:bg-neutral-50"
      >
        + Ajouter une pièce
      </motion.button>
    </div>
