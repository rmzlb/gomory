  ...
  return (
    ...
    >
              ...
              <AnimatePresence>
                {showMenu && (
                  <motion.div
                    ...
                    className="absolute right-0 z-50 mt-2 w-48 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-lg"
                  >
                    <div className="p-2">
                      <p className="px-3 py-1 text-xs text-neutral-500">Export PNG</p>
                      <button
                        onClick={() => exportPNG('small')}
                        className="w-full rounded-lg px-3 py-2 text-left text-sm transition-colors hover:bg-neutral-50"
                      >
                        📷 PNG (1x)
                      </button>
                      <button
      ...
      <div className="mt-3 flex justify-between text-xs text-neutral-500">
        ...
        <span>Utilisation: {board.strips.length} bandes</span>
      </div>
    </motion.div>
  )
}
