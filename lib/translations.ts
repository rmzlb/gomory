export const translations = {
  en: {
    ...
    home: {
      ...
      description: 'Open source implementation based on Ralph E. Gomory\'s work (1958). Complexity O(n log n). Average utilization: 70-85%.',
      cta: {
        optimizer: 'optimizer →',
        github: 'github ↗'
      },
...
• 90° rotation support`
      ...
      features: [
        {
          ...
          description: 'Vertical column partitioning followed by horizontal strip packing within each column. Reduces computational complexity while maintaining acceptable waste ratios.'
        },
        {
          title: 'Next Fit Decreasing Height (NFDH)',
          description: 'Heuristic packing algorithm with proven approximation ratio. Pieces sorted by decreasing height for optimal shelf utilization.'
        },
        {
          title: 'Kerf compensation',
          description: 'Automatic spacing calculation for saw blade width. Configurable kerf values from 0-10mm with sub-millimeter precision.'
        },
        {
          title: 'Multi-format export',
          description: 'PDF generation with jsPDF, PNG rasterization via html2canvas, native SVG export. Production-ready cutting plans with dimensional annotations.'
        }
      ],
      supportText: 'If this project is useful in your work or production, you can support its development.',
      footer: {
        license: 'MIT License',
    ...
    methodology: {
      ...
      intro: 'The Gomory cutting optimizer implements a two-stage guillotine cutting algorithm combined with the NFDH (Next Fit Decreasing Height) heuristic, providing a polynomial-time approximation for the NP-hard 2D bin packing problem.',
      sections: {
  ...
  fr: {
    ...
    home: {
      ...
      description: 'Implémentation open source basée sur les travaux de Ralph E. Gomory (1958). Complexité O(n log n). Taux d\'utilisation moyen: 70-85%.',
      cta: {
        optimizer: 'optimiseur →',
        github: 'github ↗'
      },
...
• Support rotation 90°`
      ...
      features: [
        {
          ...
          description: 'Partitionnement vertical en colonnes suivi d\'un empilement horizontal dans chaque colonne. Réduit la complexité computationnelle tout en maintenant des ratios de perte acceptables.'
        },
        {
          title: 'Next Fit Decreasing Height (NFDH)',
          description: 'Algorithme d\'empilement heuristique avec ratio d\'approximation prouvé. Pièces triées par hauteur décroissante pour une utilisation optimale des étagères.'
        },
        {
          title: 'Compensation du trait de scie',
          description: 'Calcul automatique de l\'espacement pour la largeur de lame. Valeurs de trait configurables de 0-10mm avec précision sub-millimétrique.'
        },
        {
          title: 'Export multi-format',
          description: 'Génération PDF avec jsPDF, rastérisation PNG via html2canvas, export SVG natif. Plans de découpe prêts pour la production avec annotations dimensionnelles.'
        }
      ],
      supportText: 'Si ce projet vous est utile dans vos travaux ou production, vous pouvez soutenir son développement.',
      footer: {
        license: 'Licence MIT',
    ...
    methodology: {
      ...
      intro: "L'optimiseur de découpe Gomory implémente un algorithme de découpe guillotine two-stage combiné avec l'heuristique NFDH (Next Fit Decreasing Height), fournissant une approximation en temps polynomial pour le problème NP-difficile du bin packing 2D.",
      sections: {
